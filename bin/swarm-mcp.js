#!/usr/bin/env node
// Launcher for the Swarm MCP stdio server. Dev checkout runs the TypeScript source directly via Node's
...
if (existsSync(sourceEntry)) {
    ...
    if (major < 22 || (major === 22 && minor < 6)) {
        console.error('Error: running swarm-mcp from source needs Node.js >= 22.6 (or run `pnpm build`).');
